...
<div class="top-bar">
	<a href="redirectAdmin.mackstore?pag=cadDica" class="button">Novo</a>
...
<div class="select-bar">
	<form action="redirectAdmin.mackstore" method="get">
		...
		<input type="hidden" name="pag" id="pag" value="dica">
	</form>
</div>
...
<div class="table">
	...
	<display:table id="listagem" name="listar"
		...
		<display:column title="Alterar" style="text-align: center;" url="/admin/redirectAdmin.mackstore?pag=cadDica" paramId="id" paramProperty="id"><img src="img/edit-icon.gif" style="text-align: center;"/></display:column>
		<display:column title="Excluir" style="text-align: center;" class="last" headerClass="last">
			<img src="img/hr.gif" onclick="deletaReg('${listagem.id}','${listagem.nome}','dica');" style="cursor: pointer;"/>
		</display:column>
	</display:table>
</div>